...
if (nadia.activestudent == true && nadia.paidtuition == true) {
    if (nadia.passedPF == true && nadia.passedDBSys == true && nadia.GPA >= 3.20) {
        if (nadia.seatsavailable == true) {
